# Generated by Powerlevel10k configuration wizard on 2024-07-28 at 14:28 UTC.
...
() {
  ...
  #################################[ os_icon: os identifier ]##################################
  # OS identifier color.
  typeset -g POWERLEVEL9K_OS_ICON_FOREGROUND='#32344a'
  typeset -g POWERLEVEL9K_OS_ICON_BACKGROUND='#acb0d0'
  # Custom icon.
  ...
  typeset -g POWERLEVEL9K_DIR_BACKGROUND='#444b6a'
